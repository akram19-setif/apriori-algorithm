...
System.out.println("items :A  B C B  D ");
int item[][]=new int[n][4];//cresting array of 5 items.
for(i=0;i<n;i++)//loop generating for number of transactions
 for(j=0;j<3;j++)//loop generating for items array 
...
int nt1[][]=new int[4][4];//creating array for 2-frequency itemset
 for(j=0;j<4;j++) 
    {  for(m=j+1;m<4;m++)//generating unique items for 2-frequency itemlist 
       { for(i=0;i<n;i++)
